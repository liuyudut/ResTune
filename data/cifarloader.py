...
def CIFAR10Loader(root, batch_size, split='train', num_workers=2, labeled = True, aug=None,  shuffle=True, target_list = [0, 1, 2, 3, 4]):
    if aug == None:
    ...
    dataset = CIFAR10(root=root, split=split, labeled=labeled, transform=transform, target_list = target_list)
...
if __name__ == "__main__":
    ...
    image_dataset_root = '../Datasets/CIFAR'
