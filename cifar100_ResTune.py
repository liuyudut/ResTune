...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrain_dir', type=str, default='./results/cifar100_pretrain/cifar100_labeled_classes_pretraining.pth')
    parser.add_argument('--dataset_root', type=str, default='../Datasets/CIFAR/')
    parser.add_argument('--exp_root', type=str, default='./results/')
    parser.add_argument('--model_name', type=str, default='resnet18_cifar100_ResTune.pth')
    parser.add_argument('--save_txt_name', type=str, default='results_resnet18_cifar100_ResTune.txt')
    parser.add_argument('--save_clusters_name', type=str, default='clusters_resnet18_cifar100_ResTune.mat')
    parser.add_argument('--save_feature_name', type=str,
                        default='resnet18_cifar100_ResTune_features.mat')
