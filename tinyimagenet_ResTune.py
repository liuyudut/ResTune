...
from models.resnet_ResNovel import ResNet, BasicBlock, ResNet_unlabel
...
if __name__ == "__main__":
    ...
    parser.add_argument('--update_interval', default=30, type=int) ## may be important?
    ...
    parser.add_argument('--pretrain_dir', type=str, default='./results/cifar10_pretrain/tinyimagenet_labeled_classes_pretraining.pth')
    ...
    parser.add_argument('--model_name', type=str, default='resnet18_tinyimagenet_ResTune.pth')
    parser.add_argument('--save_txt_name', type=str, default='results_resnet18_tinyimagenet_ResTune.txt')
    parser.add_argument('--save_clusters_name', type=str, default='clusters_resnet18_tinyimagenet_ResTune.mat')
    parser.add_argument('--save_feature_name', type=str,
                        default='resnet18_tinyimagenet_ResTune_features.mat')
